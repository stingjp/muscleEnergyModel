    ...
    if subj[0:4] == 'wals':
        ...
        for cond in welkconditions:
            ...
            for keys in trials:
                ...
                print('\n')
                print(trialdir)
                whatfailed = simset.analyzeSubject(subj, cond, keys, whatfailed, trackGRF=False, halfcycle=halfcycle, fitpaths=False, wantpaths=False, jointreact=False, guessmin=False, guess100=False)
