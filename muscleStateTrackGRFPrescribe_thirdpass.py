...
jointMomentTracking = osim.MocoGeneralizedForceTrackingGoal('joint_moment_tracking', 1) # type: ignore
...
ouf.IDplotter(osim.TimeSeriesTable('muscletrack_redo_moments_py.sto'), 'muscletrack_redo')
