...
Jon Stingel
04/14/2022
File to collect a single full GRF for a condition that is dispersed throughout the results
directories. The files are saved .mot files. I will collect them all into a single place. 
...
print('Collecting all the full GRF for each condition...\n')
...
expfiledir = os.path.join(repodir,'..\\expfiles\\')
grfbasedir = os.path.join(expfiledir,'fullgrffiles\\')
...
subjects = ['welk001','welk002','welk003','welk004','welk007','welk008','welk009','welk010']
    ...
    if subj[0:4] == 'wals':
        ...
        for cond in welkconditions:
            ...
            for keys in welktrials[subj+cond]:
                ...
                grffile1 = os.path.join(trialdir, 'ground_reaction_full.mot')
                # new names for when they are copied
                newname1 = subj+'_'+cond+'_'+keys+'grf_full.mot'
...
print('\n...end')
print('Now all the grf data should be consolidated.')
